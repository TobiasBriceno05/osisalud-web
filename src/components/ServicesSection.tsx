...
const services = [
  {
    ...
    description:
      "Asesoría integral en seguridad, análisis de riesgos y programas de prevención para ambientes laborales seguros.",
    details: [
  ...
  },
  {
    ...
    description:
      "Evaluaciones médicas integrales para garantizar la salud y el rendimiento del talento humano de su empresa.",
    details: [
  ...
  },
  {
    ...
    description:
      "Respalda la atención médica mediante estudios especializados que facilitan evaluaciones precisas y oportunas.",
    details: [
      "Laboratorio clínico.",
  ...
  },
  {
    ...
    description:
      "Promovemos el cuidado de la salud mediante evaluaciones médicas oportunas a través de:",
    details: [
                  ...
                  <ul className="space-y-2">
                    {service.details.map((detail) => (
                      <li key={detail} className="flex items-start gap-2 text-sm text-white/60">
                        <div className="h-1.5 w-1.5 rounded-full bg-white/50 flex-shrink-0 mt-1.5" />
                        {detail}
                      </li>
                    ))}
                  </ul>
